 ...
 */
const sheetsUrl = `https://docs.google.com/spreadsheets/d/1Sgd8yueA3DKveHvDgDambT2ZegDeNEslCjwzQHnCqbI`;
 ...
 */
const googleFields = {
    username: "entry.1989814818", // entry.USERNAME_ID
    comment: "entry.1880846870", // entry.COMMENT_ID
    postUrl: "entry.611439967", // entry.POST_URL_ID
    reply: "entry.238526900" // entry.REPLY_ID
};
...
function postComment() {
    ...
    fetch("https://docs.google.com/forms/d/e/1FAIpQLSf8AOrdNleqpmMrGyvcuFRukDlsM9SWZGZeV_k7fkcNsfdmpw/formResponse", {
        method: 'POST',
        mode: 'no-cors',
        headers: {
